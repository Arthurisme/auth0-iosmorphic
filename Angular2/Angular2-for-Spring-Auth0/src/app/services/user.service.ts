...
export  class UserService{
    ...
    bindingUserToSpring() {
        ...
        let tokenAtLocal:string = localStorage.getItem('id_token');
        console.log("tokenAtLocal storaged already user.service  was: \n");
        ...
        let header = new Headers({  'Authorization':'Bearer '+tokenAtLocal});
    ...
    public bindingUserToSpringTest1() {
        ...
        console.log("tokenAtLocal storaged user.service already was: \n");
        console.log(tokenAtLocal);
